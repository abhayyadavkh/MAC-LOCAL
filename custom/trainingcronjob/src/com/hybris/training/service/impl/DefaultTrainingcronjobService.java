...
public class DefaultTrainingcronjobService implements TrainingcronjobService
{
	private static final Logger LOG = LoggerFactory.getLogger(DefaultTrainingcronjobService.class);
	...
	{
		return DefaultTrainingcronjobService.class.getResourceAsStream("/trainingcronjob/sap-hybris-platform.png");
	}
